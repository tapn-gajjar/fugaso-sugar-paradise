...
export class MenuPaytablePageBase extends MenuPageBase {
    constructor(source) {
        super(source);
    ...
    _onCheckGraphic() {
        this._contentConf = OMY.Omy.assets.getJSON("GDPaytableContent");
        OMY.Omy.add.createEntities(this._cPageContent, this._contentConf);
