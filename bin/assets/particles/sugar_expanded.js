// 8b70b681-ac0c-4896-8d3d-81e943ce3013
...
function NeutrinoEffect(ctx) {
	...
	function Emitter_up() {
		...
		var _, _i0, _s0 = [], _2, _3 = [], _3i, _3s = [], _4 = [], _6 = [], _9, _11, _12, _13, _14 = [], _16 = [], _17=[], _17fs=[], _17vs=[], _17rw=[], _17rwn=[], _17rwl, _17v=[], _17p=[], _17dtl, _17dtp, _17df, _17fsd=[], _18, _19, _20, _20i0, _20s0 = [];
		...
		this.ud = function(Bd) {
			...
			Bd.dd();
			Bd._3 = [
				[[-364.4,-246],[360.8,-244.8],[360.8,-244.8]]
			];
			Bd._20 = [
				[
					[1,0.998793,0.995615,0.990158,0.982033,0.97074,0.955619,0.935775,0.909946,0.876279,0.831879,0.771868,0.687124,0.558127,0.340743,0.0229242,0.0229242]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
		...
		this.Pb = function(Qb, Bd, vd) {
			_i0=(Bd.Rb<0?0:(Bd.Rb>10?10:Bd.Rb));
			_i0<1?_i0<0?ctx.V(_s0,0,(_i0-0)*inf):ctx.V(_s0,1,(_i0-0)*1):_i0<1?ctx.V(_s0,2,(_i0-1)*inf):ctx.V(_s0,3,(_i0-1)*0.111111);
		...
		this.fd = function(Bd, Xb) {
			...
			Xb._10 = _9;
			_11 = 0 + Bd.Ld.rand() * (1 - 0);
			_12 = 0 + Bd.Ld.rand() * (1 - 0);
			_13 = 0 + Bd.Ld.rand() * (1 - 0);
			ctx.W(_14, _11, _12, _13);
			Xb._15 = [];
			ctx.T(Xb._15, _14);
			ctx.T(Xb.Ab, Xb._5);
		}
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_18 = 2;
			_19 = (Xb._1 / _18);
			_20i0=(_19<-0.2?-0.2:(_19>1?1:_19));
			ctx.V(_20s0,0,(_20i0- -0.2)*12.5);
	...
	this.qd = function(Ld) {
		...
		Ld.pd(new Emitter_up());
		Ld.pd(new Emitter_down());
		Ld.pd(new Emitter_left());
		Ld.pd(new Emitter_right());
	}
