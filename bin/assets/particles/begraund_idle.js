// fadda27d-d99d-418f-914f-de19a65ecef9
...
function NeutrinoEffect(ctx) {
	...
	function Emitter_DefaultEmitter() {
		...
		var _1, _2, _3, _4 = [], _6 = [], _9, _11=[], _12, _13, _14, _14i0, _14s0 = [];
		...
		this.ud = function(Bd) {
			...
			Bd._14 = [
				[
					[0,0.074945,0.166822,0.274151,0.39155,0.510051,0.620319,0.716198,0.795541,0.858874,0.90789,0.94454,0.970641,0.987756,0.997186,1,1],
					[1,0.99505,0.980336,0.955761,0.921299,0.877018,0.823125,0.760023,0.688385,0.609282,0.524343,0.436016,0.347938,0.265514,0.196795,0.153834,0.153834],
					[0.153834,0.142018,0.135453,0.134865,0.141159,0.155481,0.179311,0.214608,0.264025,0.331225,0.421264,0.540493,0.69249,0.856693,0.96432,0.977572,0.977572],
					[0.977572,0.958928,0.921917,0.874239,0.819326,0.759057,0.694592,0.626696,0.555909,0.482617,0.407103,0.329563,0.25013,0.168858,0.0856719,0,0]
				]
			];
			Bd.jd = 100;
			Bd.Vc = 0;
		...
		this.fd = function(Bd, Xb) {
			Xb._ = 0.0;
			_1 = -600 + Bd.Ld.rand() * (600 - -600);
			_2 = -600 + Bd.Ld.rand() * (600 - -600);
			_3 = 200 + Bd.Ld.rand() * (200 - 200);
			ctx.W(_4, _1, _2, _3);
			Xb._5 = [];
			ctx.c(Xb._5, Bd.Ab, _4);
			ctx.randv3gen(_6, 50, Bd.Ld.rand);
			Xb._7 = [];
			ctx.T(Xb._7, _6);
			Xb._8 = 0;
			_9 = 60 + Bd.Ld.rand() * (100 - 60);
			Xb._10 = _9;
			ctx.T(Xb.Ab, Xb._5);
		}
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			_14i0<0.8?_14i0<0.5?ctx.V(_14s0,0,(_14i0-0)*30):ctx.V(_14s0,1,(_14i0-0.5)*50):_14i0<0.973015?ctx.V(_14s0,2,(_14i0-0.8)*86.6979):ctx.V(_14s0,3,(_14i0-0.973015)*555.855);
			_14 = Db.nb(Bd._14[0][_14s0[0]],_14s0[1]);
			ctx.S(Xb.Pd,[0.5,0.5]);
			Xb.Md = Xb._8;
			ctx.V(Xb.Nd,Xb._10,Xb._10);
			ctx.T(Xb.gf,[1,1,1]);
			Xb.Od = _14;
			Xb.Qc = 0;
		}
